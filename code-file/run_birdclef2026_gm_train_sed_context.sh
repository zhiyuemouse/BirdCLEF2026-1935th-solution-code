...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/birdclef2026_gm_sed_context_v1}"
...
cmd=(
  ...
  --mixup-domain image
  --stage1-mixup-alpha 0.0
  --stage1-mixup-prob 0.0
  --stage1-cutmix-alpha 0.0
  --stage1-cutmix-prob 0.0
  --stage2-mixup-alpha 0.0
  --stage2-mixup-prob 0.0
