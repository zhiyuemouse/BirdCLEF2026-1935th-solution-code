...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/birdclef2026_gm_pcen}"
SPECTROGRAM_VARIANT="${SPECTROGRAM_VARIANT:-pcen}"
...
# Keep this branch aligned with the current mainline CNN, changing only the
# spectrogram front-end so the OOF comparison stays interpretable.
